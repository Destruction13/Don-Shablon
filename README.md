...
В приложении доступна система переключаемых тем. Подробное описание палитр и особенностей находится в [THEMES.md](THEMES.md). Темы можно выбрать в окне настроек (кнопка «⚙»).
